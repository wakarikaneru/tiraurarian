class Admin::GoodsController < AdministrationController
  ...
  def create
    ...
    respond_to do |format|
      if @good.save
        ...
        format.json { render :show, status: :created, location: [:admin, @good] }
      else
  ...
  def update
    respond_to do |format|
      if @good.update(good_params)
        ...
        format.json { render :show, status: :ok, location: [:admin, @good] }
      else
