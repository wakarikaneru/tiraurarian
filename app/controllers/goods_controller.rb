class GoodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @good.save
        format.html { redirect_to redirect_back(fallback_location: root_path, notice: "Goodをつけました。" )}
  ...
  def destroy
    if @good.user_id == current_user.id
      @good.destroy
      respond_to do |format|
        format.html { redirect_to redirect_back(fallback_location: root_path, notice: "Goodを解除しました。" )}
