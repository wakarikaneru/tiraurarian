...
ActiveRecord::Schema.define(version: 2022_01_30_104523) do
  ...
  create_table "tiramons", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["rank"], name: "index_tiramons_on_rank"
    t.index ["right"], name: "index_tiramons_on_right"
  ...
  create_table "tweets", id: :integer, charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["sentiment_magnitude"], name: "index_tweets_on_sentiment_magnitude"
    t.index ["sentiment_score"], name: "index_tweets_on_sentiment_score"
